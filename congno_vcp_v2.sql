...
,case when DATEDIFF(DAY,base5.DocDate,base5.max_doc_date_tt_final) >= 0 then DATEDIFF(DAY,base5.DocDate,base5.max_doc_date_tt_final)
...
from 
	...
	,case when isnull(base4.max_doc_date_tt,'') >= isnull(base4.max_doc_date_tt_extra,'') then isnull(base4.max_doc_date_tt,'')
